...
const Button = ({i, setFocus, focusPath}) => {
    return (
        <div className="key" onClick={() => { console.log({i}) }}>
            {i}
        </div>
    )
};
...
const Keyboard = withNavigation(App);
